...
<head>
    ...
    <title>Order History - Comparable</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="order_history.php"><i class="fas fa-list me-2"></i>My Orders</a>
                </li>
                <li class="nav-item">
            ...
            <tbody>
                <?php foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td><a href="order_details.php?order_id=<?= $order['id'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-eye me-2"></i>View</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
